...
constexpr int UI_SUBWINDOW_SHADOW_SPREAD = 4;
...
#define UI_INSTRUCTION_UPDATE_PLUGIN_CHAIN_WITHOUT_RECREATING_PNCS 0x23
...
#define UI_INSTRUCTION_NODE_NAME_CHANGE 0x21
...
#define UI_INSTRUCTION_CLEAR_SUBWINDOWS_WITH_CONTAINED_ROUTE 0x22
#define UI_INSTRUCTION_UPDATE_CORE_SCROLLS 0x19

#define UI_INSTRUCTION_HOST_PROCESSOR_SAMPLE_RATE_MISMATCH 0xa0
#define UI_INSTRUCTION_SEND_FOCUS_TO_TIMELINE 0xa1
